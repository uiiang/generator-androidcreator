...
import <%= basePackageName %>.app.data.api.AuthenticationInterceptor
import <%= basePackageName %>.app.data.api.UserAgentInterceptor
import <%= basePackageName %>.base.data.retrofit.ApiResultAdapterFactory
