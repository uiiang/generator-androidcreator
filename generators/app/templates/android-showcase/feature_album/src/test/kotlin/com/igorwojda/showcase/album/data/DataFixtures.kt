...
import <%= basePackageName %>.album.data.datasource.api.model.AlbumApiModel
import <%= basePackageName %>.album.data.datasource.api.model.AlbumListApiModel
import <%= basePackageName %>.album.data.datasource.api.model.ImageApiModel
import <%= basePackageName %>.album.data.datasource.api.model.ImageSizeApiModel
import <%= basePackageName %>.album.data.datasource.api.model.SearchAlbumResultsApiModel
import <%= basePackageName %>.album.data.datasource.api.model.TagApiModel
import <%= basePackageName %>.album.data.datasource.api.model.TagListApiModel
import <%= basePackageName %>.album.data.datasource.api.model.TrackApiModel
import <%= basePackageName %>.album.data.datasource.api.model.TrackListApiModel
