...
import <%= basePackageName %>.album.R
...
import <%= basePackageName %>.album.presentation.screen.albumdetail.AlbumDetailViewModel.UiState.Error
import <%= basePackageName %>.album.presentation.screen.albumdetail.AlbumDetailViewModel.UiState.Loading
import <%= basePackageName %>.album.presentation.util.TimeUtil
import <%= basePackageName %>.base.common.res.Dimen
import <%= basePackageName %>.base.presentation.activity.BaseFragment
import <%= basePackageName %>.base.presentation.compose.composable.DataNotFoundAnim
import <%= basePackageName %>.base.presentation.compose.composable.PlaceholderImage
import <%= basePackageName %>.base.presentation.compose.composable.ProgressIndicator
import <%= basePackageName %>.base.presentation.compose.composable.TextTitleLarge
import <%= basePackageName %>.base.presentation.compose.composable.TextTitleMedium
