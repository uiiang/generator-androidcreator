package <%= basePackageName %>.<%= librarys[idx].libraryName %>.data.datasource.api.model

// database-model-entitymodel
import <%= basePackageName %>.<%= librarys[idx].libraryName %>.data.datasource.database.model.AlbumEntityModel
// domain-model.entity
...
@Serializable
internal data class <%= librarys[idx].libraryName %>ApiModel(
